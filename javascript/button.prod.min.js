!(function (t) {
  ...
  function (t, n, e) {
    ...
    window.bmcBtnWidget =
      window.bmcBtnWidget ||
      function (t, n, e, C, a = "Cookie", r = "#fff", i = "#000", l = "#fd0") {
        (C &&
          (function () {
            try {
        ...
        let f = `<link href="https://fonts.googleapis.com/css?family=${o[a].google_font_name}&display=swap" rel="stylesheet">`,
          s = "28px",
          p = "Normal";
        ("Arial" !== o[a].google_font_name &&
          "Lato" !== o[a].google_font_name &&
          "Comic" !== o[a].google_font_name &&
          "Inter" !== o[a].google_font_name &&
          "Bree+Serif" !== o[a].google_font_name &&
          "Poppins" !== o[a].google_font_name) ||
          ((s = "24px"), (p = "Bold"));
        const u =
          f +
          '<div class="bmc-btn-container"><a class="bmc-btn" ' +
          `target="_blank" href="http://buymeacoffee.com/${n}">` +
          `${C}<span class="bmc-btn-text">${t}</span>` +
          "</a></div>";
        return (
          c
            .replace("[BG_COLOR]", e)
            .replace("[FONT]", o[a].css_font_name)
            .replace("[FONT_COLOR]", r)
            .replace("[FONT_SIZE]", s)
            .replace("[FONT_WEIGHT]", p)
            .replace("[OUTLINE_COLOR]", i)
            .replace("[COFFEE_COLOR]", l) + u
        );
      };
